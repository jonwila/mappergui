...
function LibMapperMatrixView(wrapperDiv, model)
{
	...
	this.initHorizontalScrollBar = function ($bar)
	{
	...
	this.initVerticalScrollbar = function ($bar)	
	{
	 ...
	 */
	this.addSourceSourceSignal = function (signal, index)
	{
		if(index > this.nCols)
		{
	 ...
	 * update IDs of all rows that are connected
	 */
	this.addDestinationSignal = function (signal, index)
	{
	...
	this.createCell = function (row, col)
	{
		...
		cell.addEventListener("mouseout", this.cellMouseOverHandler);
	 ...
	 */
	this.cellMouseOverHandler = function(evt)    
	{
